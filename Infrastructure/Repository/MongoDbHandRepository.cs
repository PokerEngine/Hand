...
public class MongoDbHandRepository : IHandRepository
{
    private const string CollectionName = "events";
    private readonly IMongoCollection<EventDocument> _collection;

    public MongoDbHandRepository(MongoDbClient client, IOptions<MongoDbRepositoryOptions> options)
    {
...
{
    public const string SectionName = "MongoDbHandRepository";
