    ...
    public async Task SaveViewAsync(Hand hand)
    {
        ...
        var document = new DetailViewDocument
        {
            ...
            Table = new DetailViewTable
            {
                ...
                {
                    BigBlindSeat = state.Table.Positions.BigBlind,
                    SmallBlindSeat = state.Table.Positions.SmallBlind,
                    ButtonSeat = state.Table.Positions.Button,
                    MaxSeat = state.Table.Positions.Max
                },
